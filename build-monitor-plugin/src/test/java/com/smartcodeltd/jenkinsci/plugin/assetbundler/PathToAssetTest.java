...
//        URL base = baseResourceUrlGivenByJenkins("file:///opt/jenkins/plugins/build-monitor-plugin/");
        URL base = baseResourceUrlGivenByJenkins("C:/Program Files (x86)/Jenkins/plugins/build-monitor-plugin");

        PathToAsset path = new PathToAsset(base, "less/index.less");

        assertThat(absolute(path), is("C:/Program Files (x86)/Jenkins/plugins/build-monitor-plugin/less/index.less"));
    }
